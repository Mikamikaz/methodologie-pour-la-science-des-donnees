"""kedro image_classification_dogs file for ensuring the package is executable
as `kedro-image-classification-dogs` and `python -m kedro_image_classification_dogs`
"""
import importlib
